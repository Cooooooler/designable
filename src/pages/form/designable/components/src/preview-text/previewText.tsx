...
export const Input: React.FC<React.PropsWithChildren<InputProps>> = observer(
  (props) => {
...
export const NumberPicker: React.FC<React.PropsWithChildren<InputNumberProps>> =
  observer((props) => {
    const prefixCls = usePrefixCls('form-text', props)
    const [wrapSSR, hashId] = useStyle(prefixCls)
    return wrapSSR(
...
export const Select: React.FC<React.PropsWithChildren<SelectProps<any>>> = observer(
  (props) => {
...
export const TreeSelect: React.FC<React.PropsWithChildren<TreeSelectProps<any>>> =
  observer((props) => {
    const field = useField<Field>()
    const placeholder = usePlaceholder()
    const prefixCls = usePrefixCls('form-text', props)
    ...
    const findLabel: (value: any, dataSource: any[], treeNodeLabelProp?: string) => (any) = (
      value: any,
      dataSource: any[],
...
export const Cascader: React.FC<React.PropsWithChildren<CascaderProps<any>>> =
  observer((props) => {
    const field = useField<Field>()
    const placeholder = usePlaceholder()
    const prefixCls = usePrefixCls('form-text', props)
...
export const TimePicker: ReactFC<TimePickerProps> = (props) => {
  const placeholder = usePlaceholder()
  const prefixCls = usePrefixCls('form-text', props)
  const getLabels = () => {
    const labels = formatDayjsValue(props.value, props.format, placeholder)
...
export const InternalPreviewText: ReactFC<IPreviewTextProps> = observer(
